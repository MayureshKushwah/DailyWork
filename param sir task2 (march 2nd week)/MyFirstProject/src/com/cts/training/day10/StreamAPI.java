...
//		addpro.forEach(System.out::println);
	    ...
	    //3. Sorting the list
//		 List<String> addpro2 = languages.sorted().collect(Collectors.toList());
//			addpro2.forEach(System.out::println);
			
	    //3. des Sorting the list
			List<String> addpro3 = languages.sorted((s1,s2) -> -s1.compareTo(s2)).collect(Collectors.toList());
			addpro3.forEach(System.out::println);
